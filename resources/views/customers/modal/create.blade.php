    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="customer_create">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="customer_name">Nama Customer</label>
                                <input type="text" class="form-control" placeholder="Nama Customer" name="nama_customer" id="nama_customer" onkeyup="this.value = this.value.toUpperCase();">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Fax" name="no_fax" id="no_fax">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Daerah" name="alamat_daerah" id="alamat_daerah">
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary float-left text-white">Tambah Data</button>
