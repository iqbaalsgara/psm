    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="surat_jalan_detail_create" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="row">
                            ...
                            <div id="form-barang-1"  class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control nabar" onkeyup="this.value = this.value.toUpperCase();" name="nama_barang[]" id="nama_barang1" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-1">
                                    <div class="form-group">
