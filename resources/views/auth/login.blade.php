            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h5 class="text-dark font-weight-normal">Login <span class="font-weight-bold">INVOSYS</span></h5>
                        <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                            @csrf
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input id="email" autocomplete="off" type="email" class="form-control @error('email') is-invalid @enderror" name="email" tabindex="1" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <input id="password" autocomplete="off" type="password" class="form-control @error('password') @enderror" name="password" tabindex="2" required>
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; Pancaran Sinar Matahari
                        </div>
                    </div>
                </div>
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                ...
                                <h5 class="font-weight-normal text-muted-transparent">Cibinong, Indonesia</h5>
                            </div>
                            Semangat <!-- <a class="text-light bb" target="_blank" href="https://"> -->Membangun</a>
                        </div>
                    </div>
                </div>
            </div>
